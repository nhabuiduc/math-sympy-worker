...
export class Sum extends Pr2MItemBase {
    convert(obj: P2Pr.C<"Sum"> | P2Pr.C<"Product"> | P2Pr.C<"Limit">): Pr2M.CResult {
        ...
        let funcBlocks = blockBd.wrapBracketIfConsiderSingleUnit(obj.symbols[0], this.main.convert(obj.symbols[0])).blocks;
    ...
    private convertLimit(obj: P2Pr.C<"Limit">): Pr2M.CResult {
        ...
        const expr = blockBd.wrapBracketIfConsiderSingleUnit(e, this.main.convert(e));
